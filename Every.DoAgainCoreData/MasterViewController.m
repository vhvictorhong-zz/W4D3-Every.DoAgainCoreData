...
-(void)createPerson {
    ...
    Todo *newObject = [NSEntityDescription
                         insertNewObjectForEntityForName:@"Todo"
                         inManagedObjectContext:self.context];
    newObject.title = @"Clean";
    newObject.todoDescription = @"Clean up the bedroom";
    newObject.priorityNumber = 2;
    newObject.isCompleted = NO;
    newObject.deadlineDate = [NSDate date];
...
- (void)insertNewObject:(id)sender {
    ...
    //Todo *newTo = [[Todo alloc] initWithContext:context];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.priorityLabel.text = [NSString stringWithFormat:@"Priority : %ld", (long)todo.priorityNumber];
    cell.deadlineLabel.text = [NSString stringWithFormat:@"Deadline : %@", [NSDate stringFromDate:todo.deadlineDate]];
